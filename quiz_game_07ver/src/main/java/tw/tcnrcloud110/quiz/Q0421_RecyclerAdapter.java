...
public class Q0421_RecyclerAdapter extends RecyclerView.Adapter<Q0421_RecyclerAdapter.ViewHolder> implements View.OnClickListener {
    private Context mContext;
    private ArrayList<Q0421_Post> mData;
    //    -------------------------------------------------------------------
    private OnItemClickListener mOnItemClickListener = null;
    //--------------------------------------------
    public Q0421_RecyclerAdapter(Context context, ArrayList<Q0421_Post> data) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater
                .from(mContext)
                .inflate(R.layout.q0421_cell_post, parent, false);
...
//        holder.Content = (TextView) view.findViewById(R.id.Content);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        final Q0421_Post post = mData.get(position);
