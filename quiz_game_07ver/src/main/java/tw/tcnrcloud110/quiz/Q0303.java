...
public class Q0303 extends AppCompatActivity implements View.OnClickListener {
    ...
    private final int questoverflag = 0;
    ...
    private MyAlertDialog myAltDlg;
    ...
    private final View.OnClickListener starton = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (v.getId() == R.id.q0301_b005) {
                ...
                if (count >= 0 && stateflag == 0 && count < ans.length) {//START
                    Log.d(TAG, "start");
                    bgmmusic.stop();
...
//            }
    ...
    private final DialogInterface.OnClickListener altOn = new DialogInterface.OnClickListener() {
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            finalmusic.stop();
            bgmmusic.stop();
            if(pgwork.isAlive())pgwork.stopThread();
            //qhandler.removeCallbacksAndMessages(null);
            handler.removeCallbacksAndMessages(null);
            switch (which) {
                case DialogInterface.BUTTON_NEUTRAL:
                    if (account_state) {
                        //dbHper.updateRec_Q0312_3(account.getFamilyName()+account.getGivenName(),account.getEmail(),(int)tscore);
                        //        sqlctl = "SELECT * FROM member ORDER BY id ASC";
                        ArrayList<Object> nameValuePairs = new ArrayList<>();
                        //        nameValuePairs.add(sqlctl);
                        nameValuePairs.add("q0312_3");
                        nameValuePairs.add(account_name);
                        nameValuePairs.add(account_mail);
                        nameValuePairs.add((int) tscore);
                        String result = Q0300_connectDB.executeupdate_Q0312(nameValuePairs);
                        Log.d(TAG, result);
                        try {
...
//        b005.getLayoutParams().height=displayMetrics.1widthPixels /5;
        ...
        bgmmusic = MediaPlayer.create(Q0303.this, R.raw.q0300_bg03);
        startmusic = MediaPlayer.create(Q0303.this, R.raw.q0300_bg02);
        finalmusic = MediaPlayer.create(Q0303.this, R.raw.q0300_bg01);
        correctmusic = MediaPlayer.create(Q0303.this, R.raw.q0300_c01);
        errormusic = MediaPlayer.create(Q0303.this, R.raw.q0300_e01);
...
//                }
    ...
    public void onClick(View v) {
        ...
        if (count >= 0 && count < ans.length && stateflag == 1) {
...
//                }
    ...
    protected void timeout() {
        ...
        t007.setText(getString(R.string.q0301_t008));
//        t002.setVisibility(View.INVISIBLE);
//        t003.setVisibility(View.INVISIBLE);
        ...
        count++;
        if (count >= 0 && stateflag == 1 && count < ans.length) {
...
//        this.finish();
    ...
    private void finishquiz() {
        ...
        myAltDlg = new MyAlertDialog(Q0303.this);
